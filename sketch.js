...
function setup() {
	...
	mango4 = new Mango(11390,300,30);
	mango5 = new Mango(1100,300,30);
	mango6 = new Mango(1000,300,30);
  mango7 = new Mango(1250,310,30);
...
function draw() {
  rectMode(CENTER);
 /* div {
    background: linear-gradient(to bottom, #33ccff 0%, #ccffcc 100%);
}*/
  background("#99bbff");
  push();
  stroke("#ff33cc");
  ...
  fill('white');
  textSize(24);
  text("PRESS SPACE TO GET A SECOND CHANCE TO PLAY", 550,50);
  pop();
  ground.display();
  tree.display();
  boy.display();
